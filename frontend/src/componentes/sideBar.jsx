...
const Sidebar = ({ activeWindow }) => {
  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
                ...
                <symbol id="pagina inicial" viewBox="0 0 16 16">
            ...
            <div className="d-flex flex-column flex-shrink-0 bg-body-tertiary sidebar">
                <div className="nav nav-pills nav-flush flex-column mb-auto text-centerd-flex flex-column flex-shrink-0 bg-body-tertiary" style={{ width: '4.5rem' }}>
                    <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <li>
                            <Link to="/pagInicial" className={`nav-link py-3 border-bottom rounded-0 ${activeWindow === 'pagina Inicial' && 'active'}`} title="pagina Inicial" data-bs-toggle="tooltip" data-bs-placement="right">
                                <svg className="bi pe-none" width="24" height="24" role="img" aria-label="Orders"><use xlinkHref="#pagina inicial" /></svg>
                            </Link>
                        </li>
                        <li>
